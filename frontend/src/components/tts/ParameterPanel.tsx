...
export function ParameterPanel() {
  ...
  return (
    <div className="space-y-3">
      ...
      <GlassSlider label="Exaggeration" value={exaggeration} onChange={setExaggeration} />
      <GlassSlider label="CFG Weight" value={cfgWeight} onChange={setCfgWeight} />
      <GlassSlider label="Temperature" value={temperature} onChange={setTemperature} min={0.1} max={1.5} step={0.05} />
    </div>
  )
}
